 ...
 *
 */
export function toUnixtime(timestamp : string, timezone : string) {
 ...
 *
 */
exports.getDayLetter = function(date : Date) {
 ...
 *
 */
exports.readable = function(date : string, full : boolean) {
 ...
 *
 */
export function incrDate(date : string, days : number) {
 ...
 *
 */
export function decrDate(date : string, days : number) {
...
export function stringToDate(date : string) {
  ...
  try {
    ...
    let hour : number   = Number(date.substring(8, 10));
    let minutes : number = Number(date.substring(10, 12));
    let seconds : number = Number(date.substring(12, 14));
 ...
 *
 */
exports.isLastDayofMonth = function(date : string) {

  try {
    
    let tmp = date.toString();

    let year : number  = Number(tmp.substring(0, 4));
    let month : number = Number(tmp.substring(4, 6));
    let day : number   = Number(tmp.substring(6, 8));
